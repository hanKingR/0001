package com.mywulianwang.www.tool.page;
...
public class Pager implements Serializable {
     ...
     */
    public int getPages() {
    	pages = (int) Math.ceil((double) itemsTotal / itemsPerPage);
        return pages;
    }
    ...
    public int getPreviousPage() {
    	previousPage = calcPage(curPage - 1);
        return previousPage;
    }
    ...
    public int[] getSlider() {
    	slider = getSlider(DEFAULT_SLIDER_SIZE);
        return slider;
    }
