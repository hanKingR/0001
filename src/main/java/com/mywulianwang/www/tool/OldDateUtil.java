...
import com.winenice.web.util.helper.FormatHelper;
...
public class OldDateUtil {
	...
	public static String DATE_FORMAT_DATETIMEONLY = "yyyy-MM-ddHHmmss"; // 年/月/日
	...
	public static java.util.Date toDate(String sDate) {
		return toDate(sDate, OldDateUtil.sdfDateOnly);
	}
	public static java.util.Date toDate2(String sDate) {
		return toDate(sDate, OldDateUtil.sdfDateTime);
	}
	...
	public static java.util.Date toDate(String sDate, String sFmt) {
		if (sFmt.equals(OldDateUtil.DATE_FORMAT_DATETIME)) { // "YYYY/MM/DD
			// HH24:MI:SS"
			return toDate(sDate, OldDateUtil.sdfDateTime);
			// }else if( sFmt.equals (DateUtil.DATE_FORMAT_SESSION ) ){
			// //YYYYMMDDHHMI
			// return toDate(sDate,DateUtil.sdfDateSession );
		} else if (sFmt.equals(OldDateUtil.DATE_FORMAT_DATEONLY)) { // YYYY/MM/DD
			return toDate(sDate, OldDateUtil.sdfDateOnly);
		} else {
			return null;
		}
	...
	public static String toString(java.util.Date dt) {
		...
		return toString(dt, OldDateUtil.sdfDateOnly);
	}
	...
	public static String toString(java.util.Date dt, String sFmt) {
		...
		if (sFmt.equals(OldDateUtil.DATE_FORMAT_DATETIME)) { // "YYYY/MM/DD
			// HH24:MI:SS"
			return toString(dt, OldDateUtil.sdfDateTime);
		} else { // Default , YYYY/MM/DD
			return toString(dt, OldDateUtil.sdfDateOnly);
		}
	}
	//type 1:年月日   2:小时分秒
	public static String toStringOrderDate(String st,int type) {
		if(st != null){
			java.util.Date d = toDate(st, sdfDateTime);
			if(type == 1){
				SimpleDateFormat sdf1 = new SimpleDateFormat("yyyyMMdd");
				return toString(d, sdf1);
			}else if(type == 2){
				SimpleDateFormat sdf2 = new SimpleDateFormat("HHmmss");
				return toString(d, sdf2);
			}
		}
		return null;
	}
	...
	public static boolean isSameDay(java.sql.Timestamp date1,
		...
		s1 = date1.toString().substring(0,
				OldDateUtil.DATE_FORMAT_DATEONLY.length());
	...
	public static List getAllWeekDays(int year, int weekDay) {
		...
		SimpleDateFormat f = new SimpleDateFormat(OldDateUtil.DATE_FORMAT_DATEONLY);
		c.set(year, 0, 1);
	...
	public static java.sql.Timestamp getFirstDayOfWeek(
		...
		int no = OldDateUtil.getWeekdayOfTimestamp(timestamp);
		java.sql.Timestamp out = OldDateUtil.addDays(timestamp, 1 - no);
		return out;
	}
	...
	public static java.sql.Timestamp getLastDayOfWeek(
			java.sql.Timestamp timestamp) {
		int no = OldDateUtil.getWeekdayOfTimestamp(timestamp);
		java.sql.Timestamp out = OldDateUtil.addDays(timestamp, 7 - no);
		return out;
	}
	...
	public static java.sql.Timestamp getFirstSundayOfMonth(
		...
		out = OldDateUtil.getFirstDayOfWeek(out);
		return out;
	}
	...
	public static java.sql.Timestamp getLastSaturdayOfMonth(
		...
		out = OldDateUtil.getLastDayOfWeek(out);
	...
	public static java.sql.Timestamp getFirstDayOfMonth(
		...
		int day = OldDateUtil.getDayOfTimestamp(timestamp);
		out = OldDateUtil.addDays(timestamp, 1 - day);
	...
	public static java.sql.Timestamp getLastDayOfMonth(
		...
		GregorianCalendar obj = OldDateUtil.convertTimestampToCalendar(timestamp);
		// month : 0 -- 11
		int day = 0;
		...
		if (obj.isLeapYear(obj.get(GregorianCalendar.YEAR))) {
			day = OldDateUtil.DAY_OF_MONTH_LEAP_YEAR[month - 1];
		} else {
			day = OldDateUtil.DAY_OF_MONTH_NON_LEAP_YEAR[month - 1];
		}
		/*
		 ...
		 */
		out = OldDateUtil.toSqlTimestamp(OldDateUtil.formatYMD(year, month, day));
	...
	public static java.sql.Timestamp getZeroTime(java.sql.Timestamp timestamp) {
		...
		return OldDateUtil.toSqlTimestamp(tempStr);
	}
	...
	public static String getCurrentHourAndMinuteString() {
		...
		GregorianCalendar obj = OldDateUtil.convertTimestampToCalendar(time);
		int hour = obj.get(GregorianCalendar.HOUR_OF_DAY);
		int minute = obj.get(GregorianCalendar.MINUTE);
		if (minute < 10) {
			out = String.valueOf(hour) + "0" + String.valueOf(minute);
	...
	public static java.util.GregorianCalendar convertToCalendar(
		...
		obj.setTime(OldDateUtil.convertTimestampToDate(timestamp));
	...
	public static String getSysDateString() {
		return toString(new java.util.Date(System.currentTimeMillis()),
				OldDateUtil.sdfDateOnly);
	}

	public static String getNoSpSysDateString() {
		return toString(new java.util.Date(System.currentTimeMillis()),
				OldDateUtil.sdfDateOnlyNoSp);
	}
	...
	public static java.sql.Timestamp toSqlTimestamp(String sDate) {
		...
		if (sDate.length() != OldDateUtil.DATE_FORMAT_DATEONLY.length()) {
			return null;
		}
		return toSqlTimestamp(sDate, OldDateUtil.DATE_FORMAT_DATEONLY);
	}
	...
	public static java.sql.Timestamp toSqlTimestamp(String sDate, String sFmt) {
		...
		if (sFmt.equals(OldDateUtil.DATE_FORMAT_DATETIME)) {
			temp = sDate.replace('/', '-');
			temp = temp + ".000000000";
		} else if (sFmt.equals(OldDateUtil.DATE_FORMAT_DATEONLY)) {
			temp = sDate.replace('/', '-');
	...
	public static String toSqlTimestampString(java.sql.Timestamp dt) {
		...
		return toSqlTimestampString(dt, OldDateUtil.DATE_FORMAT_DATEONLY);
	}
	...
	public static String toSqlTimestampString2(java.sql.Timestamp dt) {
		...
		String temp = toSqlTimestampString(dt, OldDateUtil.DATE_FORMAT_DATETIME);
	...
	public static String convertTimestampToChinaCalendar(Timestamp timestamp) {
		...
		if (timestamp == null) {
			...
			sb = new StringBuffer();
			sb.append(OldDateUtil.getYearOfTimestamp(timestamp));
			sb.append("年");
			sb.append(OldDateUtil.getMonthOfTimestamp(timestamp));
			sb.append("月");
			sb.append(OldDateUtil.getDayOfTimestamp(timestamp));
			sb.append("日");
			sb.append("　");
			sb.append(OldDateUtil.getHourOfTimestamp(timestamp));
			sb.append(":");
			if (OldDateUtil.getMinuteOfTimestamp(timestamp) < 10) {
				sb.append(0);
				sb.append(OldDateUtil.getMinuteOfTimestamp(timestamp));
			} else {
				sb.append(OldDateUtil.getMinuteOfTimestamp(timestamp));
			}
			sb.append(":");
			if (OldDateUtil.getSecondOfTimestamp(timestamp) < 10) {
				sb.append(0);
				sb.append(OldDateUtil.getSecondOfTimestamp(timestamp));
			} else {
				sb.append(OldDateUtil.getSecondOfTimestamp(timestamp));
			}
		}
	...
	public static String toSqlTimestampString(java.sql.Timestamp dt, String sFmt) {
		...
		if (sFmt.equals(OldDateUtil.DATE_FORMAT_DATETIME) || // "YYYY/MM/DD
				// HH24:MI:SS"
				sFmt.equals(OldDateUtil.DATE_FORMAT_DATEONLY)) { // YYYY/MM/DD
	...
	private static boolean isLastDayOfMonth(GregorianCalendar obj) {
		...
		if (obj.isLeapYear(year)) {
			if (day == OldDateUtil.DAY_OF_MONTH_LEAP_YEAR[month - 1]) {
				return true;
			}
		} else {
			if (day == OldDateUtil.DAY_OF_MONTH_NON_LEAP_YEAR[month - 1]) {
				return true;
			}
		}
		return false;
	...
	public static java.sql.Timestamp addMonths(java.sql.Timestamp timestamp,
		...
		String temp = OldDateUtil.formatYMD(year, month, day);
		out = OldDateUtil.toSqlTimestamp(temp);
		return out;
	}
	...
	public static java.sql.Timestamp addDays(java.sql.Timestamp timestamp,
		 ...
		 */
		java.util.Date date = OldDateUtil.convertTimestampToDate(timestamp);
		long temp = date.getTime();

		return new java.sql.Timestamp(temp + OldDateUtil.DAY_MILLI * days);
	}
	...
	public static java.util.Date addDays(java.util.Date date, int days) {
		...
		return new java.util.Date(temp + OldDateUtil.DAY_MILLI * days);
	}
	...
	public static java.util.Date addMinute(java.util.Date date, int minute) {
		...
		return new java.util.Date(temp + OldDateUtil.MINUTE_MILLI * minute);
	}
	...
	public static String addMinute(int minute) {
		return OldDateUtil.toString(new java.util.Date(System.currentTimeMillis()
				+ minute * OldDateUtil.MINUTE_MILLI), OldDateUtil.sdfDateTime);
	}
	/**
	 * 根据生日得到年龄
	 * 
	...
	public static void main(String[] args) {
		int day = OldDateUtil.getWeekdayOfTimestamp(new java.sql.Timestamp(System
				.currentTimeMillis()));
		...
		Timestamp t = new Timestamp(1208418103);
		System.out.println(OldDateUtil.getCurrentHourAndMinuteString());
...
//	}
	...
	public static String convertLongToTimestamp(long dateline) {
		Date t = new Date(dateline);
		return OldDateUtil.toString(t);
	}

	public static String getNoSpSysDateTimeString() {
		return toString(new java.util.Date(System.currentTimeMillis()),
				OldDateUtil.sdfDateTimeOnly);
	}
	public static String dateToString(Date date,String format) {
		...
		try {
			...
			e.printStackTrace();
			throw new IllegalArgumentException("qqqqqqqq:" + e);
		}
	} 
